...
const AnswerButtons = forwardRef<HTMLDivElement, AnswerButtonsProps>(
  ({ onClick, currentBid, previousBid, calledLiar}, ref) => {
    ...
    return (
      <div ref={ref} className={`flex flex-col lg:flex-row justify-center items-center gap-2`}>
